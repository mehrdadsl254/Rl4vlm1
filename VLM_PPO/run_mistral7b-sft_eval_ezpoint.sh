TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES="0" accelerate launch --config_file ./scripts/config_zero2.yaml --main_process_port 29380 ./main_test2.py \
    ...
    --ppo-epoch 4 \
    --mini-batch-size 1 \
    --model-path /home/mmd/RL4VLM/RL4VLM/models/llava-ezpoint_mistral7b-sft \
    --use-lora \
    --train-vision all \
    # --q8
