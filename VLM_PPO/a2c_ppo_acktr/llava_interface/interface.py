import torch
import math,sys
sys.path.append("/home/mmd/RL4VLM/Evaluate_sft")
from generation_test import test_generatoin
...
def llava_generate(value_model, tokenizer, input_ids, image_tensor, args):
    ...
    # torch.save(image_tensor, 'image_tensor.pth')
    # exit()
    ...
    with torch.inference_mode():
        ...
        # output = test_generatoin(input_ids, image_tensor)
