...
deepspeed --include localhost:0 \
   ./LLaVA/llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ./sft-data/sft-data/blackjack/blackjack.json \
    --image_folder ./sft-data/sft-data/blackjack/blackjack_data_folder \
    ...
    --bf16 True \
    --output_dir ./sft_checkpoint/llava-blackjack_mistral7b-lora \
    --num_train_epochs 1 \
